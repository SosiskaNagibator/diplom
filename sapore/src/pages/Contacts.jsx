    ...
    >
        ...
        >
          ...
          >
            ...
            <div className="flex gap-5 text-2xl text-gray-500">
              ...
              <a href={socialLink} target="_blank" rel="noopener noreferrer" className="hover:text-amber-500 transition-colors duration-200 hover:scale-110 transform" aria-label="Instagram">
                <FaInstagram />
              </a>
            </div>
          </motion.div>
      ...
      >
        ...
        <div className="h-64 rounded-xl overflow-hidden">
          <MapPicker
            onAddressSelect={() => {}}
            initialAddress="г. Ростов-на-Дону, ул. Социалистическая, 141"
          />
        </div>
