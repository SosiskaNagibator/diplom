              ...
              <div className="mt-4">
                ...
                <div className="mt-2 grid grid-cols-4 gap-2 text-sm">
                  <div className="bg-amber-50 p-2 rounded-lg text-center">
                    <span className="block font-bold text-amber-600">{pizza.calories || 0}</span>
                    <span className="text-gray-500 text-xs">ккал</span>
                  </div>
                  <div className="bg-amber-50 p-2 rounded-lg text-center">
                    <span className="block font-bold text-amber-600">{pizza.protein || 0} г</span>
                    <span className="text-gray-500 text-xs">Белки</span>
                  </div>
                  <div className="bg-amber-50 p-2 rounded-lg text-center">
                    <span className="block font-bold text-amber-600">{pizza.fat || 0} г</span>
                    <span className="text-gray-500 text-xs">Жиры</span>
                  </div>
                  <div className="bg-amber-50 p-2 rounded-lg text-center">
                    <span className="block font-bold text-amber-600">{pizza.carbs || 0} г</span>
